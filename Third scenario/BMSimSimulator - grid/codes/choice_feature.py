...
##########################################################################
    ...
    nodes[0].feature = 4 #low power
    nodes[6].feature = 4 #low power

    nodes[1].feature = 5    #friend and relay
    nodes[5].feature = 6    #friend

    #friendship
    nodes[0].friend_Id = 1
    nodes[6].friend_Id = 5

    nodes[1].LOW_POWER_ID = 0
    nodes[5].LOW_POWER_ID = 6